...
% \setcounter{chapter}{3} % -- TODO Change this!
...
\fakelabel{sec:syntax-informally}
%
...
% \fakelabel{sec:syntax-more-formally}
%
...
% For example, with the rules given below, the following is a derivation of
...
%
\subsection{Dependent pair types (\texorpdfstring{$\Sigma$}{Σ}-types)}
\fakelabel{sec:more-formal-sigma}
%
...
\fakelabel{sec:more-formal-unit}
%
% %\index{type!unit|(}%
%
\begin{mathparpagebreakable}
...
\subsection{Identity types}
%
% \fakelabel{sec:more-formal-identity}
%
% %\index{type!identity|(}%
%
...
\end{mathparpagebreakable}
% %
In $\ind{\Sn^1}$, $x$ is bound in $C$. The notation ${\dpath C \lloop b b}$ for dependent paths was introduced in Section 6.2.%\cref{sec:dependent-paths}.
% %\index{rules of type theory|)}%
%
...
%
\begin{thm}\fakelabel{thm:conversion-preserves-typing}
...
% terminates.
%
\begin{thm}\fakelabel{thm:strong-normalization}
...
%
\begin{lem}\fakelabel{lem:normal-forms}
...
% %\index{metatheory|)}%
%
% \sectionNotes\fakelabel{subsec:general-remarks}
%
